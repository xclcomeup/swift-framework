...
/**
 * FIXME 目前每个模块都需要重复扫描，后续做成分发器，扫描一次获取所有结果
 * 
 * @author yuanxl
 *
 */
@Deprecated
public abstract class AbstractMethodScan {

    private static final Logger logger = Logger.getLogger(AbstractMethodScan.class);
     ...
     * @return
     */
    public abstract List<PluginCutPoing> conventional(Class<?> clazz);
     ...
     * @return
     */
    public List<PluginCutPoing> scan() {
        ...
        for (String basePackage : basePackages) {
            ...
            try {
                ...
                for (Resource resource : resources) {
                    if (resource.isReadable()) {
                        ...
                        try {
                            ...
                            List<PluginCutPoing> describes = conventional(clazz);
                ...
                throw new RuntimeException("AbstractMethodScan scan fail", e);
            }
        }
        return list;
    }
